...
<div class="row top-pad badgeRow">
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 bottom-pad">
        <a href="http://www.houzz.com/pro/debbiecorreale/redesign-right-llc" target="_blank"><img class="img-responsive image-center bottom-pad" src="https://st.hzcdn.com/static/badge_44_8@2x.png" height='80' width='80'></a>
    </div>
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 bottom-pad">
    ...
    <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 bottom-pad">
     ...
     <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 bottom-pad">
        <a href="http://www.houzz.com/pro/debbiecorreale/redesign-right-llc" target="_blank"><img class="img-responsive image-center" src="https://st.hzcdn.com/static/badge_8_8@2x.png"></a>
    </div>
</div>
<div class="row midRow vertical-align">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
        ...
        <h2><strong>Publications:</strong> <small>(Click image to browse)</small></h2>
        <div class="row">
            <!--<div class="col-lg-1 col-md-1 col-sm-1 hidden-xs" id="heightMatcher"></div>-->
            <div class="col-lg-11 col-md-11 col-sm-11 col-xs-11">
                <div class="row bottom-pad">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <a href="decorating-magazine.htm"><img src="images/mags/2013-7.jpg" class="img img-responsive img-rounded magThumb"></a>
                    </div>
                    <div class="col-lg-6 col-md-6 hidden-sm hidden-xs">
                        <a href="decorating-magazine.htm"><img src="images/mags/2013-3.jpg" class="img img-responsive img-rounded magThumb"></a>
                    </div>
                </div>
            </div>
        </div>
