            ...
            <div class="row headlineImage hidden-xs vertical-align">
				...
				<div class='col-lg-6 col-xs-6'>
                    ...
                    <div class="row bottom-pad" id="contactInfo">
                        ...
                        <div class="col-md-4 hidden-xs hidden-sm contactInfo shrink-text-sm text-wrap">
