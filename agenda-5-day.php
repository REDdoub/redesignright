...
<div class="row">
    <div class="col-xs-12 text-center">
        <h1>FRSR Certified 5-Day Interior Redesign and Home Staging Training Program Class Agenda</h1>
    </div>
</div>
<div class="row">
...
<div class='row bottom-pad'>
    <div class='col-xs-12 text-center'>
        All material owned by Redesign Right, LLC and may not be copied or redistributed for any purpose.
    </div>
</div>
<?php
